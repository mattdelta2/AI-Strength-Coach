...
Now that your README is updated, **take a screenshot** of your app with the "Log Session" sidebar and the "Progress Chart" visible. Drag and drop that image into your GitHub repository, then add this line right under the main title in your README:
